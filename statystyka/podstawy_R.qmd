...
## Mapowanie estetyk {#mapowanie-estetyk}

## Obiekty `geom_` {#obiekty-geom_}

## Tytuły osi i wykresu {#tytuły-osi-i-wykresu}

## Wygląd wykresów {#wygląd-wykresów}

### `ggThemeAssist` {#ggthemeassist}

### Gotowe szablony {#gotowe-szablony}

# Testy statystyczne {#sec-tests}

## Czyste wyniki, czyli pakiet `broom` {#czyste-wyniki-czyli-pakiet-broom}
