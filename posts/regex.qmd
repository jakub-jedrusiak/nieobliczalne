...
2.  Nawiasy kwadratowe dopasowują dowolny znak zapisany w tych nawiasach, np. `[tk]` dopasuje s<span class="regex_match">t</span>a<span class="regex_match">t</span>ys<span class="regex_match">t</span>y<span class="regex_match">k</span>a. `[^tk]` dopasuje odwrotność, czyli <span class="regex_match">s</span>t<span class="regex_match">a</span>t<span class="regex_match">ys</span>t<span class="regex_match">y</span>k<span class="regex_match">a</span>.
