...
Pod rysunkiem [-@fig-iq-stderr-histogram]. pisałem o tym, że większość wyników mieści się w jakimśtam zakresie dookoła średniej. Ten zakres, w którym zawiera się większość wyników, nazywamy **odchyleniem standardowym** i więcej na jego temat piszę w rozdziale [-@sec-procent-wariancji].
...
[^p-value-12]: Ponownie, liczenie odchylenia standardowego omawiam dokładnie w rozdziale [-@sec-procent-wariancji].
